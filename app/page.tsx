...
export default function Home() {
  ...
  return (
    <>
      ...
      <div className="error">
        <h1>يجب دفع التكلفه المطلوبة</h1>
        <p>لااسترجاع الموقع يرجي التواصل علي رقمي الخاص</p>
        <a href="https://wa.me/201205222331" target="_blank" rel="noopener noreferrer">
          <FaWhatsapp className="text-3xl" />
          <span>تواصل معايا من هنا</span>
        </a>
        <p>كنا تمام معاكم للاخر و ناس محترمه فا اتمني يكون التعامل يكمل باحترام و شكرا لوقتكم</p>
      </div>
    </>
  );
}
