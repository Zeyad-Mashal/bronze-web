      ...
      <div className="container mx-auto px-6 grid md:grid-cols-4 gap-12">
        ...
        <div className="col-span-1 flex flex-col items-center md:items-start text-center md:text-right">
          <img
            ...
            className="w-33 mb-4"
          />
          <p className="leading-8 text-gray-300 text-sm"> مركز متخصص في تقديم خدمات احترافية لحماية وتغليف السيارات بأعلى جودة. نمتلك خبرة تمتد لأكثر من 15 عامًا في مجال حماية السيارات، تخصصنا خلالها في تقديم أحدث حلول الحماية وتطبيق أفضل الممارسات العالمية للحفاظ على سلامة المركبات وجمالها.
            عملنا مع قاعدة واسعة من العملاء، من الأفراد وحتى الشركات، مما أكسبنا فهمًا عميقًا لاحتياجات السوق المحلي وتوجهاته وتطوراته
          </p>
        </div>
